...
static struct omap_opp_def __initdata omap36xx_opp_def_list[] = {
	...
	/* MPU OPP0 - LOW2 */
	OMAP_OPP_DEF("mpu", true,  200000000,  920000), 
	/* MPU OPP1 - OPP50 */
	...
	/* MPU OPP2 - OPP80 */
	OMAP_OPP_DEF("mpu", true,  700000000,  1222500),   
	/* MPU OPP3 - OPP-Turbo */
	OMAP_OPP_DEF("mpu", true,  800000000,  1300000),
	/* MPU OPP3 - OPP0G */
	OMAP_OPP_DEF("mpu", true,  900000000,  1325000),
	/* MPU OPP4 - OPP-SB */
	OMAP_OPP_DEF("mpu", true,  1000000000, 1350000),
	/* MPU OPP5 */
	OMAP_OPP_DEF("mpu", true,  1100000000, 1450000),
	/* MPU OPP6 */
	OMAP_OPP_DEF("mpu", true,  1200000000, 1580000),
	/* MPU OPP7 */
	OMAP_OPP_DEF("mpu", true,  1300000000, 1600000),
	/* MPU OPP8 */
	OMAP_OPP_DEF("mpu", true,  1350000000, 1620000),
	...
	/* DSP OPP0 - OPP70 */
	OMAP_OPP_DEF("iva", true,  400000000, 1100000),
	/* DSP OPP2 - OPP100 */
	OMAP_OPP_DEF("iva", true,  520000000, 1162500),
	/* DSP OPP2 - OPP80 */
	OMAP_OPP_DEF("iva", true,  600000000, 1222500),
	/* DSP OPP3 - OPP-Turbo */
	OMAP_OPP_DEF("iva", true, 660000000, 1300000),
	/* DSP OPP3 - OPP0G */
	OMAP_OPP_DEF("iva", true, 700000000, 1325000),
	/* DSP OPP4 - OPP-SB */
	OMAP_OPP_DEF("iva", true, 800000000, 1350000),
	/* DSP OPP5 */
	OMAP_OPP_DEF("iva", true, 800000000, 1450000),
	/* DSP OPP6 */
	OMAP_OPP_DEF("iva", true, 800000000, 1580000),
	/* DSP OPP7 */
	OMAP_OPP_DEF("iva", true, 800000000, 1600000),
	/* DSP OPP8 */
	OMAP_OPP_DEF("iva", true, 800000000, 1620000),
};
